...
const endpoint1 = `https://api.tvmaze.com/shows/${tvShowId}/seasons`;
...
const endpoint2 = `https://api.tvmaze.com/shows/${tvShowId}/cast`;
...
showInfo.innerHTML = ''
const endpoint3 = `https://api.tvmaze.com/shows/${tvShowId}`;
